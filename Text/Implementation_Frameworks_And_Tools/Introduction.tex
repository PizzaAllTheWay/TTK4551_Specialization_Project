...
\\ \\
ROS2 is used as the central middleware for data handling, real-time communication, and debugging through tools such as RViz2 and rqt. The CAOR-MINES ParisTech UKF-M library provides a robust foundation for nonlinear state estimation and multi sensor fusion. GTSAM handles factor graph construction, preintegration, and optimization, while MRPT supports data association and perception modules for the SLAM front-end.  
\\ \\
