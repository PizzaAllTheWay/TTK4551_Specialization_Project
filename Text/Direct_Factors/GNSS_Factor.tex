...
\\ \\
Following the formulation presented in paper on GNSS measurements in Factor Graphs \cite{GNSS_Factor}, the GNSS factor is expressed as a probabilistic constraint between the estimated navigation state and the measured quantities in the NED frame:
$$
