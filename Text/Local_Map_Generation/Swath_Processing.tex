...
\\ \\
Before normalization, the sonar signal has already undergone several preprocessing steps including pitch and roll correction, blind zone removal, and slant range correction. The resulting data represent the measured acoustic backscatter intensity as a function of range and time for each ping. This measured intensity, denoted as $I(x,y)$, corresponds to the sonar data obtained up to this stage of processing, containing both the true seabed reflectivity and the effects of acoustic attenuation, beam pattern, and geometric spreading.
\\ \\
