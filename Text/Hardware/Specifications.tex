...
\todo[inline]{TAP: The previous section (3.1) was named Micro Ampere ASV, this indicates that 3.2 is not the ASV... but it is about the ASV specs... Not saying it is wrong, just think about the titles here...}
...
\todo{TAP: Add reference in table text}
\begin{table}[H]
    \centering
